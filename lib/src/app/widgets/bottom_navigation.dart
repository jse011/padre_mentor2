...
abstract class TabItemView extends State<BottomNavigationView>{
  ...
  TabItemView({this.animationController});
}
...
class BottomBarView extends StatefulWidget {
  const BottomBarView(
      {Key? key, this.icono, required this.tabIconsList, required this.changeIndex, this.addClick})
      : super(key: key);
...
typedef TapBuilder = Widget Function(BuildContext context, int position, AnimationController? animationController);