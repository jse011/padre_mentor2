...
import 'package:padre_mentor/src/app/utils/app_linkify.dart';
...
class ItemEventoView extends StatefulWidget{
  ...
  Color? color;
  ItemEventoView(this.eventoUi, {this.onClickMoreEventoAdjuntoDowload, this.onClickPreview, this.onClickPreviewComplejo, this.onClickMegusta, this.color = const Color(0XFF71bb74)});
